...
def index():
    ...
    defence_stocks = ['BEML.NS','CYIENTDLM.NS','SOLARINDS.NS','BDL.NS','DATAPATTNS.NS','COCHINSHIP.NS','BEL.NS','HAL.NS']
...
#gold&finance
 # Fetch stock data for gold&finance stocks
    ...
    return render_template('index.html', main_plot_url=main_plot_url, railway_plot_url=railway_plot_url, bank_plot_url=bank_plot_url,defence_plot_url=defence_plot_url,gold_finance_plot_url=gold_finance_plot_url)
